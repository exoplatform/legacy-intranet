...
public class BookmarkRestService implements ResourceContainer {
  ...
  /**
   * Get user's bookmarks REST service URL: /bookmarks/get
   * 
  ...
  public Response get(@Context SecurityContext sc, @Context UriInfo uriInfo) throws Exception {
    try {
      ...
      if (!userPrivateNode.hasNode("Bookmarks")) {
        ...
        String default_bookmarks =
                                 "[{\"name\":\"Discussions\", \"link\":\"/$PORTAL/$SITENAME/forum\"},{\"name\":\"Wiki\", \"link\":\"/$PORTAL/$SITENAME/wiki\"},{\"name\":\"Documents\", \"link\":\"/$PORTAL/$SITENAME/documents\"},{\"name\":\"Agenda\", \"link\":\"/$PORTAL/$SITENAME/calendar\"}]";
  ...
  /**
   * Set user's bookmarks REST service URL: /bookmarks/set/{bookmarks}
   */
  @GET
  @Path("set/{bookmarks}")
  public Response set(@PathParam("bookmarks") String bookmarks,
